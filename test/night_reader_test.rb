...
class NightReaderTest < MiniTest::Test
  ...
  def test_it_has_input_braille
    nightreader = NightReader.new('fixtures/single_braille.txt',  'readerout.txt')
  ...
  def test_it_has_input_output_files
    ...
    assert_equal 'fixtures/single_braille.txt', nightreader.file_input
  ...
  def test_it_can_confirm
    nightreader = NightReader.new('fixtures/braille1.txt',  'readerout.txt')

    assert_equal 66, nightreader.confirm
  end

  def test_it_can_translate
    nightreader = NightReader.new('fixtures/encoded.txt',  'readerout.txt')
